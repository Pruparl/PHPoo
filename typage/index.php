...
//m éthode format() de la classe DateTime pour l'affichage en version français (et autre avec une différente utilisation des codes)
echo $jean->getDateNaissance()->format('d/m/Y');

$rene = new Individu();
// erreur : l'attribut dateNaissance est null
// echop $rene->getDateNaissance()->format('d/m/Y);
